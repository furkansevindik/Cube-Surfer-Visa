    ...
    
    {
        switch (CurrentGameState)
        {
            ...
            case GameState.FinishGame:
                ...
                if (goldScore < 10){
                winScreen_1.SetActive(true);
                winGoldText.enabled = true;
                }
                
                else if (goldScore >= 10 && goldScore < 20){
                winScreen_2.SetActive(true);
                winGoldText.enabled = true;
                }
